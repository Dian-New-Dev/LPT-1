let apresentcao = {
    texto: 'Bem-vindo(a)! Sou Ana Clara Oliveira, psicóloga especializada em terapia cognitivo-comportamental, com 10 anos de experiência ajudando indivíduos a superar desafios emocionais e a encontrar um caminho para uma vida mais equilibrada e satisfatória. Acredito no poder da empatia e da escuta ativa para criar um ambiente seguro e acolhedor onde você possa explorar suas emoções, entender seus comportamentos e desenvolver estratégias eficazes para lidar com as dificuldades. Meu compromisso é oferecer um suporte personalizado e baseado em evidências para promover o seu bem-estar mental e emocional. Vamos juntos nessa jornada de autodescoberta e crescimento!',
    fotoDePerfil: 'images/fotoDePerfil.jpg',
    fotoApresentacao1: 'images/fotoApresentacao1.jpg',
...
let reviews = {
    ...
    cargo3: 'Dona de Casa',
    estrelas3: 5,
    text3: 'Ana Clara é uma profissional excepcional! Ela me ajudou a superar uma fase muito difícil da minha vida com sua abordagem compassiva e suas estratégias eficazes de TCC. O ambiente que ela cria durante as sessões é acolhedor e sem julgamentos, o que fez toda a diferença no meu tratamento. Suas orientações não só me ajudaram a lidar com meus problemas imediatos, mas também me equiparam com habilidades práticas para o futuro. Sem dúvida, ela foi uma peça-chave na minha recuperação e crescimento pessoal.',
}

//https://marketplace.canva.com/EAE4PN_YLiY/1/0/566w/canva-green-minimalist-property-client-testimony-flyer-tpGXk7rhLIo.jpg

let contato = {
    foto: 'images/fotoContato.jpg',
}